...
void main()
{
	...
	ptr_fun = system; //...и его инициализация функцией system
	...
	while (command != 0)
	{
		...
		cout << endl;
		ptr_fun("pause"); //Пауза работы программы, до нажатия любой клавиши
	}
}